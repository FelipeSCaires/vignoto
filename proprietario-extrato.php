<?php
    ...
    $request = ['extract' => ['url' => "{$config['pcoBaseUrl']}api/prestacao-contas/proprietarios/extrato/{$query['cod']}/html", 'decode' => true]];
    ...
    $seo['title'] = "Sou cliente - Extrato - {$client['nomeFantasia']}";
