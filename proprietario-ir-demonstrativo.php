<?php
    ...
    $request = ['tax' => ['url' => "{$config['pcoBaseUrl']}api/prestacao-contas/proprietarios/extrato-ir/{$query['cod']}/html", 'decode' => true]];
    ...
    $seo['title'] = "Sou cliente - Demonstrativo de IR - {$client['nomeFantasia']}";
